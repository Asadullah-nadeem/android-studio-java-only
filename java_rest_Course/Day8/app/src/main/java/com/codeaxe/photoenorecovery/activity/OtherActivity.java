...
import static com.codeaxe.photoenorecovery.utills.Utils.mAlbumOthers;
...
import com.codeaxe.photoenorecovery.adapter.OtherAdapter;
import com.codeaxe.photoenorecovery.ads.AdmobAdsModel;
import com.codeaxe.photoenorecovery.model.OtherModel;
...
public class OtherActivity extends AppCompatActivity {
    ...
    infiapp.envento.photorecoverynew.task.RecoverOthersAsyncTask mRecoverPhotosAsyncTask;
    ...
    private void gotonext() {
        ...
        if (status.equals("restore")) {
            ...
            if (tempList.size() == 0) {
                ...
                mRecoverPhotosAsyncTask = new infiapp.envento.photorecoverynew.task.RecoverOthersAsyncTask(OtherActivity.this, adapter.getSelectedItem(), new infiapp.envento.photorecoverynew.task.RecoverOthersAsyncTask.OnRestoreListener() {
                    @Override
