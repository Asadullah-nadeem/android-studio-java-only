...
public class MainActivity extends BaseActivity implements ATEActivityThemeCustomizer {
    ...
    public static com.file.ib.fie fie;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fie = new fie(ads_context, ads_context.getPackageName(), Ad_Id.Acccccc,
                Ad_Id.inter1, Ad_Id.inter2, Ad_Id.banner1, Ad_Id.banner2);

        fie.Splash_Screen(ads_context, false, 3);

        MainActivity.fie.Interstial(ads_context);
